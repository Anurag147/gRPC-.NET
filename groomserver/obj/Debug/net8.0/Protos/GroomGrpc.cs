...
namespace gRoom.gRPC.Messages {
  public static partial class Groom
  {
    ...
    public abstract partial class GroomBase
    {
      ...
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::System.Threading.Tasks.Task StartMonitoring(global::Google.Protobuf.WellKnownTypes.Empty request, grpc::IServerStreamWriter<global::gRoom.gRPC.Messages.RecievedMessage> responseStream, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }
    ...
    public static void BindService(grpc::ServiceBinderBase serviceBinder, GroomBase serviceImpl)
    {
      ...
      serviceBinder.AddMethod(__Method_StartMonitoring, serviceImpl == null ? null : new grpc::ServerStreamingServerMethod<global::Google.Protobuf.WellKnownTypes.Empty, global::gRoom.gRPC.Messages.RecievedMessage>(serviceImpl.StartMonitoring));
    }
